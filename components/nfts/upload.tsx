...
export const ImageUpload: FC<ImageUploadProps> = ({ readOnly }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      // This route creates new image and tag records in db
      // not uploading the image here, instead, create a record in the database
      // with a temporary, empty image. need to generate a pre-signed URL for the image upload.
      ...
      // includes a pre-signed uploadUrl on the record. then, send a file to db to upload
      // large files that would otherwise exceed the limit for serverless functions on services like Vercel.
