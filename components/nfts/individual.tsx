...
export const Image: FC<ImageProps> = ({ image, tags, readOnly }) => {
  ...
  // client-side transform performs after the page render so might want
  // to add a transition to account for the slight delay.
  //
  // TODO dynamically make images sizes based on viewport
  ...
  // animate the client side image on page load
