...
library DataURIs {
    ...
    function toJsonURI(string memory json) internal pure returns (string memory) {
    ...
    function toURI(string memory prefix, string memory data) private pure returns (string memory) {
